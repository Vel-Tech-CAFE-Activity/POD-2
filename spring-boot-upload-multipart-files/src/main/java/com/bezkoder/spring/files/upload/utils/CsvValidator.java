...
public class CsvValidator {
    ...
    private List<FieldConfig> loadValidationConfig() throws IOException {
    ...
    private boolean isDateFormatValid(String fieldValue, String dateFormat) {
        // Implement date format validation logic using SimpleDateFormat or other date parsing libraries
        return true;
    }
